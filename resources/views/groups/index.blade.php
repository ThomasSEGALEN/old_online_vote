            ...
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <div class="flex flex-wrap flex-row items-center justify-between">
                    <div>
                        ...
                        <x-primary-button class="flex items-center my-2" onclick="window.location='{{ route('groups.create') }}'">
                            {{ __('Créer un groupe') }}
                        </x-primary-button>
                        @endcan
                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                                            ...
                                            <td class="flex space-x-5 px-6 py-4">
                                                <button
                                                    x-data=""
                                                    x-on:click.prevent="$dispatch('open-modal', 'groupShow-{{ $group->id }}')"
                                                >
                                                    <svg
                                                        class="w-5 h-5"
                                                        xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <button
                                                    x-data=""
                                                    x-on:click.prevent="$dispatch('open-modal', 'groupDelete-{{ $group->id }}')"
                                                >
                                                    <svg
                                                        class="w-5 h-5"    
                                                        xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <div class="p-6">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <div class="max-h-48 overflow-y-auto">
                                                        @foreach ($group->users->sortBy('last_name')->sortBy('first_name') as $user)
