<x-app-layout>
    <x-slot name="header">
        <a href="{{ route('users.show', $user) }}" class="inline-flex justify-center items-center mr-2">
                                ...
                                <div class="w-full px-3 mb-10 md:mb-4">
                                    ...
                                    <div class="h-48 px-1 overflow-y-auto">
                                        ...
                                        <div class="@error ('role_id') is-invalid @enderror form-check flex flex-row">
                                            ...
                                            id="roleInput-{{ $role->id }}" type="radio" name="role_id" value="{{ $role->id }}" @if ($user->role->id === $role->id) checked @endif>
