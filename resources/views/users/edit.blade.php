                        ...
                        <div class="w-full flex flex-row justify-between">
                            <div class="flex flex-col w-1/2 -mx-3">
                                <div class="w-full px-3 mb-3 md:mb-6">
                                    ...
                                    <input id="titleInputMan" type="radio" name="title_id" value="1" @if ($user->title_id === 1) checked @endif />
                                    <label for="titleInputMan" class="mr-5">Monsieur</label>
                                    <input id="titleInputWoman" type="radio" name="title_id" value="2" @if ($user->title_id === 2) checked @endif />
                                ...
                                <div class="w-full px-3 mb-3 md:mb-6">
                                    ...
                                    <input
                                        ...
                                        id="lastNameInput" type="text" name="last_name" value="{{ $user->last_name }}">
                                    @error('last_name')
                                ...
                                <div class="w-full px-3 mb-3 md:mb-6">
                                    ...
                                    <input
                                        ...
                                        id="firstNameInput" type="text" name="first_name" value="{{ $user->first_name }}">
                                    @error('first_name')
                                    <span class="text-red-600">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="w-full px-3 mb-3 md:mb-6">
                                    ...
                                    <input
                                        ...
                                        id="emailInput" type="email" name="email" value="{{ $user->email }}">
                                    @error('email')
                                    <span class="text-red-600">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="flex flex-col w-1/2 h-full -mx-3">
                                <div class="w-full px-3 mb-3 md:mb-6">
                                    ...
                                    <div class="@error('role_id') is-invalid @enderror form-check flex flex-row">
                                        ...
                                        id="roleInput" type="checkbox" name="role_id[]" value="{{ $role->id }}" @foreach ($user->roles as $userRole) @if ($role->id === $userRole->id ) checked @endif @endforeach>
                                ...
                                <div class="w-full px-3 mb-3 md:mb-6">
                                    ...
                                    <div class="@error('group_id') is-invalid @enderror form-check flex flex-row">
                                        <input class="form-check-input appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"
                                        id="groupInput" type="checkbox" name="group_id[]" value="{{ $group->id }}" @foreach ($user->groups as $userGroup) @if ($group->id === $userGroup->id) checked @endif @endforeach>
