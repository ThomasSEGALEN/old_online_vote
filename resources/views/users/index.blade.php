                                    ...
                                    <tbody>
                                        ...
                                        <tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                                            ...
                                            <td class="flex space-x-5 px-6 py-4">
                                                <button
                                                    x-data=""
                                                    x-on:click.prevent="$dispatch('open-modal', 'userShow-{{ $user->id }}')"
                                                >
                                                    <svg
                                                        class="w-5 h-5"
                                                        xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <button
                                                    x-data=""
                                                    x-on:click.prevent="$dispatch('open-modal', 'userDelete-{{ $user->id }}')"
                                                >
                                                    <svg
                                                        class="w-5 h-5"    
                                                        xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            >
                                                ...
                                                <div class="p-6">
                                                    ...
                                                    <p class="mt-1 text-sm text-gray-600">
                                                        {{ __('Une fois que cet utilisateur est supprimé, toutes ses données seront définitivement
                                                        effacées.') }}
                                                    </p>
                                                    <div class="mt-6 flex justify-end space-x-4">
                                                        <x-secondary-button
