                ...
                <div class="relative p-6 bg-white border-b border-gray-200">
                    ...
                    <div>
                        ...
                        <div class="flex flex-col space-y-2">
                            ...
                            @foreach ($role->permissions->sortBy('id') as $permission)
                                ...
                                <div class="w-fit text-xs inline-flex font-bold leading-sm uppercase px-3 py-1 bg-gray-200 text-gray-700 rounded-full">
                                    <svg
                                ...
                                <div class="w-fit text-xs inline-flex font-bold leading-sm uppercase px-3 py-1 bg-blue-200 text-blue-700 rounded-full">
                                    <svg
                                        class="w-4 h-4 mr-2 fill-current"
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 576 512"
                                ...
                                <div class="w-fit text-xs inline-flex font-bold leading-sm uppercase px-3 py-1 bg-green-200 text-green-700 rounded-full">
                                    <svg
                                        class="w-4 h-4 mr-2 fill-current"
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 448 512"
                                ...
                                <div class="w-fit text-xs inline-flex font-bold leading-sm uppercase px-3 py-1 bg-yellow-200 text-yellow-700 rounded-full">
                                    <svg
                                        class="w-4 h-4 mr-2 fill-current"
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 512 512"
                                ...
                                <div class="w-fit text-xs inline-flex font-bold leading-sm uppercase px-3 py-1 bg-red-200 text-red-700 rounded-full">
                                    <svg
                                        class="w-4 h-4 mr-2 fill-current"
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 448 512">
